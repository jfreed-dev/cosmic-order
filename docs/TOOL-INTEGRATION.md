...
### Phase T3: Real-time Sync

- [ ] Neovim RPC client for live theme updates
- [ ] Ghostty OSC escape sequence for color reload
- [ ] File watchers for tools without IPC

**Deliverable**: Instant theme propagation

### Phase T4: Hook System

- [ ] Implement hook directory structure
- [ ] User-configurable tool enable/disable
...
toml = "0.8"  # For colors.toml parsing
kdl = "4"  # For Zellij config
serde_yaml = "0.9"  # For lazygit config

# Neovim RPC
nvim-rs = "0.6"

# D-Bus (Ghostty, system integration)
