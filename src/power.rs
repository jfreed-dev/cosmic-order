...
pub fn power_subscription() -> cosmic::iced::Subscription<PowerState> {
    cosmic::iced::Subscription::run_with(std::any::TypeId::of::<PowerSubscriptionMarker>(), |_| {
        cosmic::iced::stream::channel(
            4,
            |mut output: cosmic::iced_futures::futures::channel::mpsc::Sender<PowerState>| async move {
